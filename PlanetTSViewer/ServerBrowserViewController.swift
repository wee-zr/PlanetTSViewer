...
class ServerBrowserViewController: UITableViewController, ServerBrowserDelegate {
    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        cell.textLabel!.text = serverInfo.name
        cell.detailTextLabel!.text = "\(serverInfo.address)  users \(serverInfo.users) / \(serverInfo.slots)"
    }
